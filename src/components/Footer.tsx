        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://www.linkedin.com/company/104933301/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-ahoora-purple transition-colors" onClick={() => {
