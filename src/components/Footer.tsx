        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            <Link to="/" className="inline-block mb-4">
              <img src="https://www.ahoora.ai/static/media/ahoora_metflow.07c613ecb98eaea112a6.png" alt="Ahoora Logo" className="h-10" />
            </Link>
            <p className="text-gray-600 max-w-xs">Ahoora helps marketers make better decisions with AI-powered insights from their search marketing data.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-ahoora-purple transition-colors">Careers</a></li>
              <li><a href="#" className="text-gray-600 hover:text-ahoora-purple transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-600 hover:text-ahoora-purple transition-colors">Contact</a></li>
            </ul>
          </div>
